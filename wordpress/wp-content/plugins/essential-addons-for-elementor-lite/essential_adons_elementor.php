...
function eael_admin_notice() {
  if ( current_user_can( 'install_plugins' ) ) {
    ...
    if ( ! get_user_meta($user_id, 'eael_ignore_notice284') ) {
      echo '<div class="eael-admin-notice updated" style="display: flex; align-items: center; padding-left: 0; border-left-color: #EF4B53"><p style="width: 42px;">';
      echo '<img style="width: 100%; display: block;"  src="' . plugins_url( '/', __FILE__ ).'admin/assets/images/icon-sale.svg'. '" ></p><p> ';
      printf(__('<strong>Biggest Black Friday Deal in Elementor Universe</strong>! Get <strong>Lifetime Unlimited</strong> License for <strong>Essential Addons</strong> just for <strong>$79.97</strong> instead of $199! [Limited Availability]. <a href="https://wpdeveloper.net/buy/ea-blackfriday" target="_blank" style="text-decoration: none;"><span class="dashicons dashicons-smiley" style="margin-left: 10px;"></span> Grab The Deal</a>
